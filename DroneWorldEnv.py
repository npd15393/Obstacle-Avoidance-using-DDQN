...
class DroneGridworldEnv(discrete.DiscreteEnv):
    ...
    def _calculate_transition_prob(self, current, delta, winds):
        ...
        return [(1.0, new_-state, -1.0, is_done)]

    def __init__(self,shape=(10,10),winds=None):
        self.shape = shape
        ...
        super(DroneGridworldEnv, self).__init__(nS, nA, P, isd)
